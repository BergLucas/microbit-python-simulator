...
def get_x() -> int:
    """The acceleration measurement in the `x` axis in milli-g.

    It is as a positive or negative integer.

    Returns:
        int: The acceleration measurement in the x axis in milli-g.
            By default the accelerometer is configured with a range of +/- 2g,
...
def get_y() -> int:
    """The acceleration measurement in the `y` axis in milli-g.

    It is as a positive or negative integer.

    Returns:
        int: The acceleration measurement in the y axis in milli-g.
            By default the accelerometer is configured with a range of +/- 2g,
            and so this method will return within the range of +/- 2000mg.
    """
...
def get_z() -> int:
    """The acceleration measurement in the `z` axis in milli-g.

    It is as a positive or negative integer.

    Returns:
        int: The acceleration measurement in the z axis in milli-g.
            By default the accelerometer is configured with a range of +/- 2g,
            and so this method will return within the range of +/- 2000mg.
    """
...
def get_values() -> tuple[int, int, int]:
    """The acceleration measurements in all axes at once.

    It is a three-element tuple of integers ordered as X, Y, Z.

    Returns:
        tuple[int, int, int]: The acceleration measurements
            in all axes at once, as a three-element tuple of integers
            ordered as X, Y, Z. By default the accelerometer is configured
            with a range of +/- 2g, and so X, Y, and Z will be within
            the range of +/-2000mg.
    """
...
def get_strength() -> int:
    """Get the acceleration measurement of all axes combined, as a positive integer.

    This is the Pythagorean sum of the X, Y and Z axes.
...
def set_range(value: Literal[2, 4, 8]) -> None:
    ...
    It is set to the closest values supported by the hardware,
