...
class Display:
    ...
    def show(self, value: Union[Image, int, str, Iterable], delay: int = 400, *, wait: bool = True, loop: bool = False, clear: bool = False):
    ...
    def scroll(self, value: Union[Image, int, str, Iterable], delay: int = 150, *, wait: bool = True, loop: bool = False, monospace: bool = False):
