...
def init(
    ...
    .. warning::
        Changing the I²C pins from defaults will make the accelerometer and compass stop working,
        as they are connected internally to those pins.
...
def scan() -> list[int]:
    ...
    Returns:
        list[int]: A list of 7-bit addresses corresponding to those devices that responded to the scan.
    """
    ...
...
def read(addr: int, n: int, repeat: bool = False) -> bytes:
    ...
    Args:
        ...
        repeat (bool, optional): Whether to send a stop bit after reading. Defaults to False.
...
def write(addr: int, buf: Union[bytes, bytearray], repeat: bool = False) -> None:
    ...
    Args:
        ...
        repeat (bool, optional): Whether to send a stop bit after writing. Defaults to False.
    """
    ...
